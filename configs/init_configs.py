...
def get_argument(parser=None):
    ...
    parser.add_argument('--run-interval', type=int, default=int(20e4),
                        help='Interval to run the trained model')
    parser.add_argument('--show-run-progress', action='store_true',
                        help='Call `render` during policy runs')
    parser.add_argument('--run-episodes', type=int, default=50,
                        help='Number of episodes for each policy run')
    parser.add_argument('--save-run-path', action='store_true',
                        help='Save trajectories from policy runs')
    parser.add_argument('--show-run-images', action='store_true',
                        help='Show input images to neural networks when an episode finishes')
    parser.add_argument('--save-run-movie', action='store_true',
    ...
    parser.add_argument('--n-steps', type=int, default=10,
                        help='Number of history steps for logging, 3 for image and 10 for vector')
